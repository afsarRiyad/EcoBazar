...
const Sale = () => {
  const count = useCountDown("2026-8-31")
  return (
    <Container>
      <div className='grid lg:grid-cols-3 sm:grid-cols-2 gap-4 pt-15 pb-7'>
        <div className='relative'>
          <img src={sale1} alt="sale1"  className='cursor-pointer w-full ' />
          {/* timer countdown  */}
          <div className='absolute xl:top-29 sm:top-24 top-22 left-1/2 -translate-x-1/2 flex gap-3 font-pop text-white w-54 '>
           <div >
        ...
        <img src={sale3} alt="sale3"  className='cursor-pointer hidden sm:block'/>
        <img src={sale2} alt="sale2" className='cursor-pointer hidden lg:block' />
      </div>
    </Container>
  )
}
