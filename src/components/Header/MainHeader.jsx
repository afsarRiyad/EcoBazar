            ...
            <Container>
                <div className="flex justify-between items-center py-5 sm:py-9 font-pop gap-1 sm:gap-0">
                    ...
                    <div className='flex-shrink-1 relative gap-[1px]'>
                        <CiSearch className='absolute top-1/2 sm:top-1/2 right-3 cursor-pointer -translate-y-1/2 sm:left-4 text-gray-900 w-5 h-5' />
                    <input type="text" className='sm:px-11 px-3 w-50 sm:w-100 sm:py-3 py-2 pr-10  border font-pop rounded-l border-gray-300 outline-none focus:border-gray-300 focus:ring-2  placeholder:text-gray-500 placeholder:text-[15px]   focus:ring-gray-200 transition'
                            placeholder='Search' />
